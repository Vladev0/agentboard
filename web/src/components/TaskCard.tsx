...
export function TaskCard({ task }: { task: TaskSummary }) {
  ...
  return (
    <button
      ...
      className="mb-2 flex w-full cursor-grab flex-col gap-1.5 rounded-md border border-neutral-150 bg-white px-2.5 py-2 text-left shadow-sm hover:border-neutral-300 active:cursor-grabbing dark:border-neutral-800 dark:bg-neutral-900 dark:hover:border-neutral-700"
    >
